...
# 可用域名列表 - 替換為您自己的域名
EMAIL_DOMAINS = ["yoyonet.indevs.in"]
EMAIL_PREFIX = "yoyo"
...
# ==========================================
# Worker 域名 - 替換為您的 Cloudflare Worker 網域
WORKER_DOMAIN = "https://curl.yoyonet.indevs.in"

# Worker API 金鑰 - 替換為您的 API 金鑰
WORKER_API_KEY = "g3TDCYpvKXYmbRkt11QtcuFX0198BuH"
